...
PALETTE = {
    "plaster": (0.79, 0.80, 0.77),
    "accent": (0.38, 0.48, 0.43),
    "stone": (0.56, 0.58, 0.56),
    "frame": (0.80, 0.81, 0.78),
    "glass": (0.22, 0.29, 0.31),
    "metal": (0.19, 0.22, 0.23),
    "wood": (0.38, 0.28, 0.19),
    "brick": (0.60, 0.43, 0.31),
    "roof": (0.49, 0.53, 0.54),
    "leaf": (0.30, 0.40, 0.27),
    "soil": (0.29, 0.27, 0.23),
    "concrete": (0.64, 0.65, 0.62),
}
...
class MeshBuilder:
    def __init__(self, parcel):
        ...
        self.materials = [
            {"name": name, "color": color} for name, color in PALETTE.items()
        ]
