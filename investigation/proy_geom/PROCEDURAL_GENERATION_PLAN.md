...
| `footprint_xy` | huella construida después del retiro | heurística de `layout.py` |
...
5. **Materiales planos.** GLB solo tiene color, metallic y roughness constantes;
   faltan UV, texturas, normales, AO, transparencia e interiores falsos.
