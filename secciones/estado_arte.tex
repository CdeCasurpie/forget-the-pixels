...
El paradigma clásico de reconstrucción 3D está representado principalmente por \textbf{COLMAP} \cite{schonberger2016structure} (2016). Funciona a través de algo llamado Structure-from-Motion (SfM) para calcular la posición de las cámaras y lo junta con Multi-View Stereo (MVS), que juntos permiten la generación y densificación de una nube de puntos de la escena. Sirve para recuperar la geometría asumiendo que hay suficientes correspondencias visuales claras entre las imágenes.
